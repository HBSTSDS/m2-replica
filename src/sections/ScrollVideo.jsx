...
// Vídeo está em assets_externos/assets/
const videoSrc = "https://flaviobrick.com.br/assets_externos/assets/Fachada_v2.mp4";
    ...
    const tick = () => {
      ...
      if (video.readyState >= 2 && video.duration) {
        ...
        if (Math.abs(diff) > 0.05) {
          // Seek direto para não travar em lerp lento
