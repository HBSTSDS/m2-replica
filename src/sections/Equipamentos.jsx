...
// Lista fixa de arquivos que sabemos que existem na pasta Equipamentos
const EQUIPAMENTOS_FILES = [
  "nozomi_14000.png",
  "EFI_vutek_H5.jpg",
  ...
  "kongsberg_c441.png",
  "massivit_1800_1.png",
  "meevo_mx_event_seas1.png",
  "wuppertal_MDPW-3201.jpg",
  "wuppertal MDPW-320.png",
  "wuppertal MDPW-320i.png",
  "jwei_cut_sl16321.jpg",
  "kongsberg_c64.jpg"
];
...
const aliasMap = {
  ...
  // Aliases para novos caminhos fornecidos pelo usuário
  jwei_cut_sl16321: "jwei_cut_sl1632",
...
/* MONTA A LISTA FINAL */
const equipamentosItems = EQUIPAMENTOS_FILES
  .sort((a, b) => {
    const fileA = a.toLowerCase();
    const fileB = b.toLowerCase();
  ...
  .map((file) => {
    const src = remoteAsset(`Equipamentos/${file}`);
...
export default function Equipamentos() {
  ...
  return (
    <section className="w-full bg-[#EEF0F6] py-12 md:py-20 overflow-hidden relative">
      ...
      {/* IMAGEM PRINCIPAL - Agora com altura controlada e centralizada */}
      <div className="relative w-full h-[300px] md:h-[500px] bg-white/30 flex justify-center items-center mb-4 overflow-hidden">
        <img
          src={items[active].src}
          alt={items[active].title}
          className="max-w-full max-h-full object-contain select-none transition-opacity duration-300"
          draggable="false"
          key={items[active].src} // Força uma pequena transição ao trocar
        />
      </div>
