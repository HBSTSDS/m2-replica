...
const voilaImg = remoteAsset("Displays/voila.png");
const autoImg = remoteAsset("Displays/displaysauto.png");
const redBoxLogo = remoteAsset("Displays/redBox.png");
const raioBg = remoteAsset("Displays/raio_display.png");
const selosImg = remoteAsset("Displays/selos.png");
const evoImg = remoteAsset("Displays/displaysevo.png");
const flashImg = remoteAsset("Displays/displaysflash.png");
const popupImg = remoteAsset("Displays/displayspopup.png");
const porticoImg = remoteAsset("Displays/displaysportico.png");

// Gallery Images
const gallery1 = remoteAsset("Displays/Maskgroup.png");
const gallery2 = remoteAsset("Displays/displayAovivo.png");
const gallery3 = remoteAsset("Displays/displayLivros.png");
const gallery4 = remoteAsset("Displays/displayCachorro.png");
const gallery5 = remoteAsset("Displays/displayMuie.png");
const gallery6 = remoteAsset("Displays/displayPorta.png");
