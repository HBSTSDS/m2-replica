...
const headerImg = remoteAsset("projetosEspeciais/headerPE.png");
const img2 = remoteAsset("projetosEspeciais/img-2.png");
  ...
  return (
    <main className="bg-[#E7E9F2] text-[#4B4B48]">
      ...
      <section className="w-full">
        <img
          src={headerImg}
          alt="Projetos Corporativos Especiais e Ativações de Marca M2 Flex"
        ...
        <div className="grid md:grid-cols-3 gap-10 md:gap-14 items-start">
          ...
          <aside>
            <figure className="rounded-xl overflow-hidden bg-white shadow-sm">
              <img
                src={img2}
                alt="Exemplo de projeto especial cenográfico produzido pela M2 Flex"
