  ...
  return (
    <main className="bg-[#E7E9F2] text-[#4B4B48]">
      ...
      <section className="w-full">
        <img
          src="/projetosEspeciais/header.png"   // troque p/ .jpg se for o caso
        ...
        <div className="grid md:grid-cols-3 gap-10 md:gap-14 items-start">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-5 leading-relaxed text-[16px] md:text-[17px]">
              <p>
                Criamos ativações e estruturas personalizadas, unindo engenharia,
                design e produção para experiências únicas. Lorem ipsum dolor sit
                amet consectetur adipisicing elit. Cupiditate facilis cum
                dignissimos, eveniet vel omnis.
              </p>
              <p>
                Do conceito ao pós-instalação, nossa operação 360º garante
                viabilidade técnica, segurança e acabamento premium. Lorem ipsum
                dolor sit amet consectetur adipisicing elit. Vitae, repellendus
                perspiciatis.
              </p>
              <p>
                Atendemos projetos de grande escala em todo o Brasil com prazos
                competitivos e controle de qualidade. Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Accusantium, tenetur!
              </p>
            </div>
          </div>
          ...
          <aside className="md:pl-2">
            <figure className="rounded-xl overflow-hidden shadow-sm bg-white">
              <img
                src="/projetosEspeciais/img-2.png"  // troque p/ .jpg se for o caso
