...
import capaImg from "../../assets/nossaHistoria/capa.png"; // ✅ caminho atualizado
  ...
  return (
    <section className="bg-[#F3F4F6] text-[#1E1E1E] font-inter">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-10 py-14">
        ...
        <p className="mt-5 text-[16px] md:text-[17px] leading-7 max-w-[62ch] space-y-5">
          Esse passo marca um dos maiores movimentos de expansão da M2,
        ...
        <p className="mt-5 text-[16px] md:text-[17px] leading-7 max-w-[62ch] space-y-5">
          No Rio de Janeiro e São Paulo, atendemos nacionalmente. A integração
          entre unidades potencializa nossa atuação e fortalece nossa trajetória
          brilhante, garantindo agilidade, segurança e qualidade em cada
          entrega. Acreditamos que essa expansão é apenas o começo de uma nova
          etapa de fortalecimento da marca M2, sustentada por talento,
          relacionamento e compromisso com nossos parceiros e clientes.
        </p>
      </div>
