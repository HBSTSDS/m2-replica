...
const headerImg = remoteAsset("vitrinismos/header.png");
const img2 = remoteAsset("vitrinismos/vitrinismo.png");
...
export default function Vitrinismos() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setStatus("error");
      alert(`Erro de envio: ${err.message || "Erro de conexão"}`);
    }
  };
